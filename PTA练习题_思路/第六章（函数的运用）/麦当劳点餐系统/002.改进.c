...
void list(int arr[],int n){
 ...
 for(i=0;i<n;i++){
        switch(arr[i]){
        case 1: puts("大杯可乐*1"); break;
        case 2: puts("大杯咖啡*1"); break;
        case 3:puts("大冰淇凌*1"); break;
        case 4: puts("汉堡王*1"); break;
        case 5:puts("风味薯条*1"); break;
        case 6:puts("脆皮鸡*1"); break;
        case 7:puts("鸡块饭*1"); break;
        case 8:puts("鸡块全家桶*1");break;
        case 9:puts("麻辣鸡腿*1");break;
        }
